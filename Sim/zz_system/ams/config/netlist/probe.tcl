...
probe -create -emptyok -database ams_database {zz_system.I28.VIN}
probe -create -emptyok -database ams_database {zz_system.I28.VREF_ADC}
probe -create -emptyok -database ams_database {zz_system.I28.I8.net8}
