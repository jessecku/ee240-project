#!/bin/ksh
# This script was generated Sun Dec  8 21:07:57 2019 by:
#
...
#	-newlvs \
#	/home/cc/ee140/fa19/class/ee140-abc/Documents/ee240-project/AssuraLVS/COMP_LVS.xcn \
#	-assura_run_dir \
#	/home/cc/ee140/fa19/class/ee140-abc/Documents/ee240-project/AssuraLVS \
#	-assura_run_name COMP_LVS -rcxdir \
#	/home/cc/ee140/fa19/class/ee140-abc/Documents/ee240-project/AssuraLVS/COMP_LVS \
#	-xy_coordinates c,r -type full -temperature 27.0 -tempdir \
#	/home/cc/ee140/fa19/class/ee140-abc/Documents/ee240-project/AssuraLVS/COMP_LVS/rcx_temp \
...
#	/home/cc/ee140/fa19/class/ee140-abc/Documents/ee240-project/AssuraLVS/COMP_LVS/extview.tmp \
...
##NETS_FILE=/dev/null
##OUTPUT=/home/cc/ee140/fa19/class/ee140-abc/Documents/ee240-project/AssuraLVS/COMP_LVS/extview.tmp
...
##RC_FREQUENCY=
##RCXDIR=/home/cc/ee140/fa19/class/ee140-abc/Documents/ee240-project/AssuraLVS/COMP_LVS
##RCXFS_HIGH=N
...
##TEMPDIR=/home/cc/ee140/fa19/class/ee140-abc/Documents/ee240-project/AssuraLVS/COMP_LVS/rcx_temp
##TEMPERATURE=27.0
##TYPE=full
...
TEMPDIR=`setTempDir /home/cc/ee140/fa19/class/ee140-abc/Documents/ee240-project/AssuraLVS/COMP_LVS/rcx_temp`
export TEMPDIR
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
OUTPUT_HIERARCHY_DELIMITER='/'
cd /home/cc/ee140/fa19/class/ee140-abc/Documents/ee240-project/AssuraLVS/COMP_LVS
...
vdbToRcx \
	/home/cc/ee140/fa19/class/ee140-abc/Documents/ee240-project/AssuraLVS \
	COMP_LVS -unit meters -- -V1 -H satfile -r \
	/home/cc/ee140/fa19/class/ee140-abc/Documents/ee240-project/AssuraLVS/COMP_LVS.xcn \
	-df2 -xgl
...
flattenLayers -m cont contSD met2trm met1trm polytrm nsd psd nwtrm bulk \
	...
	contSD_ntapc_ptapc contP via1 nwtrm_ntapc_ovia nwtrm1_ntapc_ovia \
	nwtrm1 bulk_ptapc_ovia
endFlattenInputs
...
export CAP_GROUND
reconnect -float floatlvsnetsfile -tf ne_MOS_43,pe_MOS_45 -df p_dnw_DIODE_157 \
	-probe met1_text:met1trm:met1_text_fvia
...
connect -V -relocate NET np_rnwtrm:np_rnwtrm.conn np_rbulk:np_rbulk.conn \
	...
	rcontP rvia1 ne_MOS_43_mgvia pe_MOS_45_mgvia - bulk_ptapc_ovia,2,15 \
	contSD_nsd_ntapc,3,9 contSD_nsd_psd,3,4 contSD_nsd_ptapc,3,15 \
	contSD_ntapc_ptapc,9,15 contSD_psd_ntapc,4,9 contSD_psd_ptapc,4,15 \
	cont_ndiff_pdiff,5,11 ndiff_ndiff_ptapc_butt_ovia,5,6 \
	ndiff_ptapc_ovia,5,15 nsd_nsd_ntapc_butt_ovia,3,7 \
	nsd_nsd_ptapc_butt_ovia,3,8 nsd_ntapc_ovia,3,9 nsd_ptapc_ovia,3,15 \
	ntapc_nsd_ntapc_butt_ovia,9,7 ntapc_pdiff_ntapc_butt_ovia,9,12 \
	ntapc_psd_ntapc_butt_ovia,9,13 nwtrm1_ntapc_ovia,10,9 \
	nwtrm_ntapc_ovia,1,9 pdiff_ntapc_ovia,11,9 \
...
rex -V -m -pd -I'#' -tech \
	...
	np_rmet1trm::MET1_cut np_rmet2trm::MET2_cut - rcontP,1,2,t \
	...
	ne_MOS_43_mgvia,1,z pe_MOS_45_mgvia,1,z - L1T0,2,I
...
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -L3A -h -R METTP -b \
	MET1,POLY1,active,sub -Maxw 6.6 -p MET2:MET2_cut,key,METTP,key \
	0,4.6,0 - MET2_METTP.sip
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -h -b MET1,POLY1,active,sub -t METTP \
	-Maxw 4.2 -p MET2:MET2_cut,key,MET3,key 0,5.6,0 - MET2_MET3.sip
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -L3A -h -R MET3 -b POLY1,active,sub -t \
	METTP -k MET2:0.565 -Maxw 4.2 -p MET1:MET1_cut,key,MET3,key 0,5.6,0 - \
	MET1_MET3.sip
...
sw3d -V -cgnd ${CAP_GROUND} -sub 2 -b MET1,POLY1,active,sub -t METTP -p \
	MET2:MET2_cut,MET3 - MET2_MET3.sw3d
...
pax16 -V -gnd ${CAP_GROUND} -rmselfC -ignore_cf_table -scf sip.cmd -rP \
	np_rmet2trm.res,np_rmet1trm.res,np_rpolytrm.res,mwires.res,dwires.res \
	-M_perim_off -c \
	/home/ff/ee140/fa19/xfab/XKIT/xt018/cadence/v8_0/QRC_assura/v8_0_1/XT018_1231/QRC-Typ/qrcTechFile \
	-f sub active POLY1:POLY1_cut MET1:MET1_cut MET2:MET2_cut MET3 METTP \
	GateLayers - \
	/home/ff/ee140/fa19/xfab/XKIT/xt018/cadence/v8_0/QRC_assura/v8_0_1/XT018_1231/QRC-Typ/qrcTechFile \
	- - NET - capfile
...
xreduce -V -mergecap -n NET -tech \
	/home/ff/ee140/fa19/xfab/XKIT/xt018/cadence/v8_0/QRC_assura/v8_0_1/XT018_1231/QRC-Typ \
	-d1 -e METTP,MET3,MET2,MET1,POLY1,active,sub,rcontP,rvia1 -sr -g \
	${CAP_GROUND},1.0 -danglingR -minR 0.001 -rP \
	np_rmet2trm.res,np_rmet1trm.res,np_rpolytrm.res,mwires.res,dwires.res \
	-minC 1e-17 -minCper 0.1 -cap capfile L1T0 ne_MOS_43.transnr \
	pe_MOS_45.transnr p_dnw_DIODE_157.dpaxr
...
advgen -V -g0 -li -f -n -o HSPICE -TL L1T0 -sc caps2dversion -mx capfile \
	...
	mwires.res,mwires.dev2 -rPm dwires.mod dwires.res,dwires.dev2 -ta \
