#!/bin/ksh
# This script was generated Tue Dec 10 06:08:59 2019 by:
#
...
#	-newlvs \
#	/home/cc/ee140/fa19/class/ee140-abc/Documents/ee240-project/AssuraLVS/opamp2_kevin_extract_LVS.xcn \
#	-assura_run_dir \
#	/home/cc/ee140/fa19/class/ee140-abc/Documents/ee240-project/AssuraLVS \
#	-assura_run_name opamp2_kevin_extract_LVS -rcxdir \
#	/home/cc/ee140/fa19/class/ee140-abc/Documents/ee240-project/AssuraLVS/opamp2_kevin_extract_LVS \
#	-xy_coordinates c,r -type full -temperature 27.0 -tempdir \
#	/home/cc/ee140/fa19/class/ee140-abc/Documents/ee240-project/AssuraLVS/opamp2_kevin_extract_LVS/rcx_temp \
...
#	/home/cc/ee140/fa19/class/ee140-abc/Documents/ee240-project/AssuraLVS/opamp2_kevin_extract_LVS/extview.tmp \
...
##ASSURA_RUN_NAME=opamp2_kevin_extract_LVS
...
##NETS_FILE=/dev/null
##OUTPUT=/home/cc/ee140/fa19/class/ee140-abc/Documents/ee240-project/AssuraLVS/opamp2_kevin_extract_LVS/extview.tmp
...
##RC_FREQUENCY=
##RCXDIR=/home/cc/ee140/fa19/class/ee140-abc/Documents/ee240-project/AssuraLVS/opamp2_kevin_extract_LVS
##RCXFS_HIGH=N
...
##TEMPDIR=/home/cc/ee140/fa19/class/ee140-abc/Documents/ee240-project/AssuraLVS/opamp2_kevin_extract_LVS/rcx_temp
##TEMPERATURE=27.0
##TYPE=full
...
TEMPDIR=`setTempDir /home/cc/ee140/fa19/class/ee140-abc/Documents/ee240-project/AssuraLVS/opamp2_kevin_extract_LVS/rcx_temp`
export TEMPDIR
DEVICE_FINGER_DELIMITER='@'
HIERARCHY_DELIMITER='/'
OUTPUT_HIERARCHY_DELIMITER='/'
cd /home/cc/ee140/fa19/class/ee140-abc/Documents/ee240-project/AssuraLVS/opamp2_kevin_extract_LVS
...
vdbToRcx \
	/home/cc/ee140/fa19/class/ee140-abc/Documents/ee240-project/AssuraLVS \
	opamp2_kevin_extract_LVS -unit meters -- -V1 -H satfile -r \
	/home/cc/ee140/fa19/class/ee140-abc/Documents/ee240-project/AssuraLVS/opamp2_kevin_extract_LVS.xcn \
	-df2 -xgl
...
geom -V vtpCON met3trm mtptrm - vtpCON,111,i,2
geom -V vtpcmh cmh mtptrm - vtpcmh,111,i,2
geom -V bmh met3trm - bmh_met3trm_ovia,11,i,1
...
flattenCapData cmmh_CAP_66 meters
flattenDiodeData p_dnw_DIODE_157 meters
flattenLayers -m cont contSD mtptrm met3trm met2trm met1trm polytrm nsd psd \
	nwtrm bulk nsd_ptapc_ovia ptapc nsd_nsd_ptapc_butt_ovia \
	...
	contSD_ntapc_ptapc contP via1 via2CON vtpCON vtpcmh cmh \
	bmh_met3trm_ovia bmh nwtrm_ntapc_ovia nwtrm1_ntapc_ovia nwtrm1 \
	bulk_ptapc_ovia
endFlattenInputs
...
export CAP_GROUND
reconnect -float floatlvsnetsfile -tf nel_MOS_44,pel_MOS_46 -cf cmmh_CAP_66 \
	-df p_dnw_DIODE_157 -probe \
	poly_text:polytrm:poly_text_fvia,met1_text:met1trm:met1_text_fvia
...
selectNetsByNumber power_list_nums bmh p_rbmh np_rbmh
selectNetsByNumber power_list_nums bulk p_rbulk np_rbulk
selectNetsByNumber power_list_nums cmh p_rcmh np_rcmh
...
selectNetsByNumber power_list_nums mtptrm p_rmtptrm np_rmtptrm
...
mergevia -V -tech \
	/home/ff/ee140/fa19/xfab/XKIT/xt018/cadence/v8_0/QRC_assura/v8_0_1/XT018_1231/QRC-Typ \
	-cnt np_rvtpCON rvtpCON - np_rmet3trm np_rmtptrm
...
connect -V -relocate NET np_rbmh:np_rbmh.conn np_rnwtrm:np_rnwtrm.conn \
	np_rbulk:np_rbulk.conn np_rcmh:np_rcmh.conn np_rnsd:np_rnsd.conn \
	np_rpsd:np_rpsd.conn np_rndiff:np_rndiff.conn \
	...
	rcontP rvia1 rvia2CON rvtpCON nel_MOS_44_mgvia pel_MOS_46_mgvia - \
	bulk_ptapc_ovia,3,17 contSD_nsd_ntapc,5,11 contSD_nsd_psd,5,6 \
	contSD_nsd_ptapc,5,17 contSD_ntapc_ptapc,11,17 contSD_psd_ntapc,6,11 \
	contSD_psd_ptapc,6,17 cont_ndiff_pdiff,7,13 \
	ndiff_ndiff_ptapc_butt_ovia,7,8 ndiff_ptapc_ovia,7,17 \
	nsd_nsd_ntapc_butt_ovia,5,9 nsd_nsd_ptapc_butt_ovia,5,10 \
	nsd_ntapc_ovia,5,11 nsd_ptapc_ovia,5,17 \
	ntapc_nsd_ntapc_butt_ovia,11,9 ntapc_pdiff_ntapc_butt_ovia,11,14 \
	ntapc_psd_ntapc_butt_ovia,11,15 nwtrm1_ntapc_ovia,12,11 \
	nwtrm_ntapc_ovia,2,11 pdiff_ntapc_ovia,13,11 \
	pdiff_pdiff_ntapc_butt_ovia,13,14 psd_ntapc_ovia,6,11 \
	psd_psd_ntapc_butt_ovia,6,15 psd_psd_ptapc_butt_ovia,6,16 \
	psd_ptapc_ovia,6,17 ptapc_ndiff_ptapc_butt_ovia,17,8 \
...
geom -V bmh_met3trm_ovia np_rbmh.conn - tmp_rbmh_met3trm_ovia,11,i,2
mergevia -V -i -tech \
	/home/ff/ee140/fa19/xfab/XKIT/xt018/cadence/v8_0/QRC_assura/v8_0_1/XT018_1231/QRC-Typ \
	-cnt tmp_rbmh_met3trm_ovia rbmh_met3trm_ovia - np_rmet3trm np_rbmh
/bin/rm -f tmp_rbmh_met3trm_ovia
...
geom -V vtpcmh np_rcmh.conn - tmp_rvtpcmh,11,i,2
mergevia -V -i -tech \
	/home/ff/ee140/fa19/xfab/XKIT/xt018/cadence/v8_0/QRC_assura/v8_0_1/XT018_1231/QRC-Typ \
	-cnt tmp_rvtpcmh rvtpcmh - np_rmtptrm np_rcmh
/bin/rm -f tmp_rvtpcmh

#==========================================================#
# Assign net numbers to nonresistive layers
#==========================================================#

epick -V -reo -e rbmh_met3trm_ovia -e rcontSD_met1trm_nsd -e \
	rcontSD_met1trm_ntapc -e rcontSD_met1trm_psd -e rcontSD_met1trm_ptapc \
	-e rcont_met1trm_ndiff -e rcont_met1trm_pdiff -e rvtpcmh np_rnsd.conn \
	tmp_nsd
...
epick -V -reo -e rbmh_met3trm_ovia -e rcontSD_met1trm_nsd -e \
	rcontSD_met1trm_ntapc -e rcontSD_met1trm_psd -e rcontSD_met1trm_ptapc \
	-e rcont_met1trm_ndiff -e rcont_met1trm_pdiff -e rvtpcmh np_rpsd.conn \
	tmp_psd
...
epick -V -reo -e rbmh_met3trm_ovia -e rcontSD_met1trm_nsd -e \
	rcontSD_met1trm_ntapc -e rcontSD_met1trm_psd -e rcontSD_met1trm_ptapc \
	-e rcont_met1trm_ndiff -e rcont_met1trm_pdiff -e rvtpcmh \
	np_rnwtrm.conn tmp_nwtrm
...
epick -V -reo -e rbmh_met3trm_ovia -e rcontSD_met1trm_nsd -e \
	rcontSD_met1trm_ntapc -e rcontSD_met1trm_psd -e rcontSD_met1trm_ptapc \
	-e rcont_met1trm_ndiff -e rcont_met1trm_pdiff -e rvtpcmh np_rbmh.conn \
	tmp_bmh
epick -V -reo -e tmp_bmh -c np_rbmh.conn tmp1_bmh
geom -V tmp1_bmh np_rbmh - tmp1_bmh,11,i,2
geom -V tmp_bmh,tmp1_bmh - np_rbmh,1,i,1
/bin/rm -f tmp_bmh tmp1_bmh
epick -V -reo -e rbmh_met3trm_ovia -e rcontSD_met1trm_nsd -e \
	rcontSD_met1trm_ntapc -e rcontSD_met1trm_psd -e rcontSD_met1trm_ptapc \
	-e rcont_met1trm_ndiff -e rcont_met1trm_pdiff -e rvtpcmh np_rcmh.conn \
	tmp_cmh
epick -V -reo -e tmp_cmh -c np_rcmh.conn tmp1_cmh
geom -V tmp1_cmh np_rcmh - tmp1_cmh,11,i,2
geom -V tmp_cmh,tmp1_cmh - np_rcmh,1,i,1
/bin/rm -f tmp_cmh tmp1_cmh

#==========================================================#
# Process text layers
#==========================================================#

flatlabel -V  -tc -F poly_text,met1_text L1T0,L2T0
...
rex -V -m -pd -I'#' -tech \
	...
	np_rmtptrm::METTP_cut - rbmh_met3trm_ovia,4 rcontP,1,2,t \
	rcontSD_met1trm_nsd,2,t rcontSD_met1trm_ntapc,2,t \
	rcontSD_met1trm_psd,2,t rcontSD_met1trm_ptapc,2,t \
	rcont_met1trm_ndiff,2 rcont_met1trm_pdiff,2 rvia1,2,3,t \
	rvia2CON,3,4,t rvtpCON,4,5,t rvtpcmh,5,t nel_MOS_44_mgvia,1,z \
	pel_MOS_46_mgvia,1,z - L1T0,1,I L2T0,2,I
...
/bin/rm -f bmh
geom np_rbmh,p_rbmh - bmh,1,i,1
/bin/rm -f bulk
geom np_rbulk,p_rbulk - bulk,1,i,1
/bin/rm -f cmh
geom np_rcmh,p_rcmh - cmh,1,i,1
/bin/rm -f nsd
...
createLink cmh cmmh_CAP_66_cmh_cvia
createLink bmh cmmh_CAP_66_bmh_cvia
reconnect -V -se2 cwires.res -n NET -c cmmh_CAP_66.cpax:cmmh_CAP_66.cpaxr \
	cmmh_CAP_66 cmmh_CAP_66_cmh_cvia,cmmh_CAP_66_bmh_cvia
...
geom -V -i p_rmtptrm,np_rmtptrm - so_METTP,1,n
geom -V p_rmtptrm,np_rmtptrm - METTP,1,i,1
...
grow -V -0.001 cmmh_CAP_66 g_dev
geom cmmh_CAP_66 g_dev MET3 - MET3_in,111,i,3 MET3_out,001,i,3 MET3_new_cut,101
/bin/rm -f g_dev
emerge MET3_cut MET3_new_cut tmp_cut
/bin/mv -f tmp_cut MET3_cut
grow -V -0.001 cmmh_CAP_66 g_dev
geom cmmh_CAP_66 g_dev METTP - METTP_in,111,i,3 METTP_out,001,i,3 METTP_new_cut,101
/bin/rm -f g_dev
emerge METTP_cut METTP_new_cut tmp_cut
/bin/mv -f tmp_cut METTP_cut
relocate -V -n NET MET3_in METTP_in
...
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -L3A -h -b MET2,MET1,POLY1,active,sub \
	-Maxw 6.6 -p MET3:MET3_cut,key,METTP:METTP_cut,key 0,5.6,0 - \
	MET3_METTP.sip
sip -V -s -cgnd ${CAP_GROUND} -sub 2 -L3A -h -R METTP -b \
	MET1,POLY1,active,sub -k MET3:0.565 -Maxw 6.6 -p \
	MET2:MET2_cut,key,METTP:METTP_cut,key 0,4.6,0 - MET2_METTP.sip
...
sw3d -V -cgnd ${CAP_GROUND} -sub 2 -b MET2,MET1,POLY1,active,sub -p \
	MET3:MET3_cut,METTP:METTP_cut - MET3_METTP.sw3d
...
pax16 -V -gnd ${CAP_GROUND} -rmselfC -ignore_cf_table -scf sip.cmd \
	...
	np_rmtptrm.res,np_rmet3trm.res,np_rmet2trm.res,np_rmet1trm.res,np_rpolytrm.res,mwires.res,cwires.res,dwires.res \
	-M_perim_off -c \
	...
	MET3:MET3_cut METTP:METTP_cut GateLayers - \
	/home/ff/ee140/fa19/xfab/XKIT/xt018/cadence/v8_0/QRC_assura/v8_0_1/XT018_1231/QRC-Typ/qrcTechFile \
	- - NET - capfile
relocate -V -r maxnetfile -n NET MET3 METTP rcontP rvia1 rvia2CON rvtpCON

#==========================================================#
# Generate netlister data files
#==========================================================#

createCAPModelFile lvscap.mod1 cmmh4t#20ivpcell#20PRIMLIB 1 cmmh_CAP_66 cmh bmh 
...
xreduce -V -mergecap -n NET -tech \
	/home/ff/ee140/fa19/xfab/XKIT/xt018/cadence/v8_0/QRC_assura/v8_0_1/XT018_1231/QRC-Typ \
	-d1 -e \
	METTP,MET3,MET2,MET1,POLY1,active,sub,rcontP,rvia1,rvia2CON,rvtpCON \
	-sr -g ${CAP_GROUND},1.0 -danglingR -minR 0.001 -rP \
	np_rmtptrm.res,np_rmet3trm.res,np_rmet2trm.res,np_rmet1trm.res,np_rpolytrm.res,mwires.res,cwires.res,dwires.res \
	-minC 1e-17 -minCper 0.1 -cap capfile L1T0 L2T0 nel_MOS_44.transnr \
	pel_MOS_46.transnr cmmh_CAP_66.cpaxr p_dnw_DIODE_157.dpaxr
...
advgen -V -g0 -li -f -n -o HSPICE -TL L1T0,L2T0 -sc caps2dversion -mx capfile \
	...
	np_rmtptrm.res,Rnp_rmtptrm.dev2 np_rmet3trm.res,Rnp_rmet3trm.dev2 \
	np_rmet2trm.res,Rnp_rmet2trm.dev2 np_rmet1trm.res,Rnp_rmet1trm.dev2 \
	np_rpolytrm.res,Rnp_rpolytrm.dev2 -rPm mwires.mod \
	mwires.res,mwires.dev2 -rPm cwires.mod cwires.res,cwires.dev2 -rPm \
	dwires.mod dwires.res,dwires.dev2 -ta lvsmos.mod,nel_MOS_44.net \
	nel_MOS_44.transnr -ta lvsmos.mod,pel_MOS_46.net pel_MOS_46.transnr \
	-p lvscap.mod1,cmmh_CAP_66.net cmmh_CAP_66.cpaxr -dM \
...
geom METTP.df2  np_rmtptrm - np_rmtptrm,11,i,1
geom MET3.df2  np_rmet3trm - np_rmet3trm,11,i,1
geom MET2 np_rmet2trm - np_rmet2trm,11,i,1
...
stamp -i2 np_rmet3trm rvtpCON np_rvtpCON
ereduce  rbmh_met3trm_ovia rbmh_met3trm_ovia.reduce
stamp -i  np_rbmh rbmh_met3trm_ovia.reduce
stamp -i  rbmh_met3trm_ovia.reduce rbmh_met3trm_ovia
stamp -i  rbmh_met3trm_ovia bmh_met3trm_ovia
/bin/rm -f rbmh_met3trm_ovia.reduce
...
ereduce  rvtpcmh rvtpcmh.reduce
stamp -i  np_rcmh rvtpcmh.reduce
stamp -i  rvtpcmh.reduce rvtpcmh
stamp -i  rvtpcmh vtpcmh
/bin/rm -f rvtpcmh.reduce
...
vtpcmh vtpcmh
cmh np_rcmh p_rcmh
bmh_met3trm_ovia bmh_met3trm_ovia
bmh np_rbmh p_rbmh
